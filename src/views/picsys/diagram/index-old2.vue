<template>
  <div class="app-container">
    ...
    <!-- 添加或修改设备对话框 -->
    <el-dialog :title="title" :visible.sync="open" width="600px" :modal="false">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-row>
          <el-col :span="24">
            <el-form-item label="上级目录" label-width="101px" prop="parentId">
              <treeselect
  ...
  methods: {
    ...
    editDiagramNode() {
      ...
      getinfo(diagramId).then(response => {
        ...
        // this.fileList.push(this.form.fname)
        this.open = true
        this.title = "修改设备"
      });
    },
    ...
    submitForm() {
      if (this.form.nodeType == 0) {
        console.log(this.form.nodeType, 1111)
        ...
        console.log(this.form.nodeType, 2222)
        this.addFormes()
      }else {
        console.log(this.form.nodeType, 3333)
        return
      }
    ...
    addFormes() {
      ...
      console.log(this.form.nodeName, 1111)
    ...
    setWarnImgHtml(imgUrl){
      ...
      var tempObject = `
        <div style="position:absolute; top:0px; left:0px;text-align:center; background-color:white;z-index:9">
