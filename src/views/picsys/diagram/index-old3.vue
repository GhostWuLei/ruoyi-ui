    ...
    <el-row :gutter="20">
      ...
      <el-col :span="18" :xs="24">
        ...
        <el-row>
          ...
          <div id="canvas" style="position:absolute; top:0px; left:0px; width:100%; height:800px; text-align:center; background-color:white">
...
export default {
  ...
  methods: {
    ...
    editNode() {
      if(this.form.fname && this.form.fpath){
        // 
      }
    },
...
//         if (this.form.nodeType == 0) {
//           this.type = this.form.nodeType
//           console.log(this.form.fname, this.form, 3);
//           if(!this.file && !this.form.fname) return this.msgError('请上传文件')
//           uploadPic(this.file)
//             .then(res => {
//               console.log(res,333);
