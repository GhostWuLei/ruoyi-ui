<template>
  <div class="app-container">
    ...
    <!-- <el-dialog class="elclass" :visible.sync="open" width="600px">
    ...
    <!-- 添加或修改设备对话框 -->
    <el-dialog :modal="false" :title="title" :visible.sync="open" width="600px" append-to-body>
    ...
    <!-- 删除的弹框 -->
    <el-dialog center class="deleteDia" :visible.sync="showDelete" width="400px" append-to-body>
