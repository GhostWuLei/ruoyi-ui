<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="studentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="状态" align="center" prop="studentStatus" :formatter="statusFormat" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="状态" prop="studentStatus">
          <el-select v-model="form.studentStatus" filterable placeholder="请选择" clearable>
            <el-option 
...
<script>
import { listStudent, getStudent, delStudent, addStudent, updateStudent, exportStudent } from "@/api/stutestsys/student";
